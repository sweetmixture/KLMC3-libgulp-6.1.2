...
#ifdef KLMC_DEBUG_A
  ! wkjee
  write(*,'(A,I8,I8)') "in secondpass.F90 (0) : before calling changemaxcfg : estmaxcfg maxcfg : ", estmaxcfg, maxcfg
  ! wkjee end
#endif
...
#ifdef KLMC_DEBUG_A
    ! wkjee
    write(*,'(A,I8,I8)') "in secondpass.F90 (1) : before calling changemaxcfg : estmaxcfg maxcfg : ", estmaxcfg, maxcfg
    ! wkjee end
#endif
    call changemaxcfg
  endif
