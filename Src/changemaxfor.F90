...
!
  ...
  call realloc(ltib4body,maxfor,ierror)
  if (ierror.ne.0) call outofmemory('changemaxfor','ltib4body')
  call realloc(ltif4body,maxfor,ierror)
  if (ierror.ne.0) call outofmemory('changemaxfor','ltif4body')
!
