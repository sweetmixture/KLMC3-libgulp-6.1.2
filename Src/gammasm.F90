...
!
!  Julian Gale, CIC, Curtin University, Feb 2021
!
  use datatypes
...
!
  if (r.gt.rqeqtaper) then
    ...
    d2gamfafb = d2gamfafb*tpfn + 2.0_dp*dgamfafb*dtpfn + gamfafb*d2tpfn
    dgamfafb = dgamfafb*tpfn + gamfafb*dtpfn
    gamfafb = gamfafb*tpfn
!
    d2gamafb = d2gamafb*tpfn + 2.0_dp*dgamafb*dtpfn + gamafb*d2tpfn
    dgamafb = dgamafb*tpfn + gamafb*dtpfn
    gamafb = gamafb*tpfn
!
    d2gambfa = d2gambfa*tpfn + 2.0_dp*dgambfa*dtpfn + gambfa*d2tpfn
    dgambfa = dgambfa*tpfn + gambfa*dtpfn
    gambfa = gambfa*tpfn
  endif
#ifdef TRACE
  call trace_out('gammasm')
