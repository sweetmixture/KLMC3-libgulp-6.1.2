...
!
          do j = 1,nmolcore(i)
            ...
            fphase(ii+1) = fphase(ii+1) + aphase(k)*dcmplx(occuf(l),0.0_dp)
            fphase(ii+2) = fphase(ii+2) + aphase(k)*dcmplx(occuf(l),0.0_dp)
            fphase(ii+3) = fphase(ii+3) + aphase(k)*dcmplx(occuf(l),0.0_dp)
          enddo
!
