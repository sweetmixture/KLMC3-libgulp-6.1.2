...
#ifdef KLMC_DEBUG_A
        ! wkjee
        write(ioout,'(A)') "wkjee flag reale 1"
#endif
...
!
    ldog1 = (lmdl.or.lsg1.or.lbsmat(nsft+nrelf2a(i)).or.(leem.or.lgfnff).or.lDoQDeriv1)
    ldog2 = (lsg2.or.lbsmat(nsft+nrelf2a(i)).or.(leem.or.lgfnff).or.lDoQDeriv2)
...
#ifdef KLMC_DEBUG_A
      ! wkjee
      write(ioout,'(A)') "wkjee flag reale 2"
#endif
