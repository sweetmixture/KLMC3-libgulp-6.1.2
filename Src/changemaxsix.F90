...
!
  ...
  call realloc(ltib6body,maxsix,ierror)
  if (ierror.ne.0) call outofmemory('changemaxsix','ltib6body')
  call realloc(ltif6body,maxsix,ierror)
  if (ierror.ne.0) call outofmemory('changemaxsix','ltif6body')
!
