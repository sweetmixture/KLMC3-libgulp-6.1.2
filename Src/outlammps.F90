...
!  10/21 Correction added for shell output 
!
!  Conditions of use:
!
...
!
  use current
  use element,        only : atmass, maxele
  use gulp_files
  use gulp_lengths
...
!
                if (npottype.eq.1) then
                  if (llammpsvar) then
                    write(itmp,'(''pair_coeff '',a8,1x,a8,3(1x,f13.10),1x,f8.4,1x,f8.4)') &
                      varlab2,varlab1,twopot(1,n),twopot(2,n),twopot(3,n),tapermin,rpot(n)
                  else
                    write(itmp,'(''pair_coeff '',i3,1x,i3,3(1x,f13.10),1x,f8.4,1x,f8.4)') &
                      isp2,isp1,twopot(1,n),twopot(2,n),twopot(3,n),tapermin,rpot(n)
                  endif
                else
                  if ((cutp_local-tapermin).gt.1.0d-12) then
                    if (llammpsvar) then
                      write(itmp,'(''pair_coeff '',a8,1x,a8,'' buck/mdf '',3(f13.10,1x),f8.4,1x,f8.4)') &
                        varlab2,varlab1,twopot(1,n),twopot(2,n),twopot(3,n),tapermin,rpot(n)
                    else
                      write(itmp,'(''pair_coeff '',i3,1x,i3,'' buck/mdf '',3(f13.10,1x),f8.4,1x,f8.4)') &
                        isp2,isp1,twopot(1,n),twopot(2,n),twopot(3,n),tapermin,rpot(n)
                    endif
                  else
                    if (llammpsvar) then
                      write(itmp,'(''pair_coeff '',a8,1x,a8,'' buck '',3(f13.10,1x),f8.4,1x,f8.4)') &
                        varlab2,varlab1,twopot(1,n),twopot(2,n),twopot(3,n),tapermin,rpot(n)
                    else
                      write(itmp,'(''pair_coeff '',i3,1x,i3,'' buck '',3(f13.10,1x),f8.4,1x,f8.4)') &
                        isp2,isp1,twopot(1,n),twopot(2,n),twopot(3,n),tapermin,rpot(n)
                    endif
                  endif
                endif
