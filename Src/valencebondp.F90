  subroutine valencebondp(xkv,ykv,zkv)
!
...
!
!  11/21 Created from valencebond
...
!
  ...
  if (status/=0) call outofmemory('valencebondp','nvbijptr')
  allocate(bv(maxvbnbr),stat=status)
  if (status/=0) call outofmemory('valencebondp','vb')
  allocate(bvv(3,maxvbnbr),stat=status)
  if (status/=0) call outofmemory('valencebondp','vbv')
!
  allocate(d1i(maxvbnbr),stat=status)
  if (status/=0) call outofmemory('valencebondp','d1i')
  allocate(d2i(maxvbnbr),stat=status)   
  if (status/=0) call outofmemory('valencebondp','d2i')
!***************************************************
...
!
        derv2(ix,kx) = derv2(ix,kx) - d2eidr2*xki*xji*cosik
        derv2(iy,kx) = derv2(iy,kx) - d2eidr2*xki*yji*cosik
        derv2(iz,kx) = derv2(iz,kx) - d2eidr2*xki*zji*cosik
        derv2(ix,ky) = derv2(ix,ky) - d2eidr2*yki*xji*cosik
        derv2(iy,ky) = derv2(iy,ky) - d2eidr2*yki*yji*cosik
        derv2(iz,ky) = derv2(iz,ky) - d2eidr2*yki*zji*cosik
        derv2(ix,kz) = derv2(ix,kz) - d2eidr2*zki*xji*cosik
        derv2(iy,kz) = derv2(iy,kz) - d2eidr2*zki*yji*cosik
        derv2(iz,kz) = derv2(iz,kz) - d2eidr2*zki*zji*cosik
!
        dervi(ix,kx) = dervi(ix,kx) + d2eidr2*xki*xji*sinik
        dervi(iy,kx) = dervi(iy,kx) + d2eidr2*xki*yji*sinik
        dervi(iz,kx) = dervi(iz,kx) + d2eidr2*xki*zji*sinik
        dervi(ix,ky) = dervi(ix,ky) + d2eidr2*yki*xji*sinik
        dervi(iy,ky) = dervi(iy,ky) + d2eidr2*yki*yji*sinik
        dervi(iz,ky) = dervi(iz,ky) + d2eidr2*yki*zji*sinik
        dervi(ix,kz) = dervi(ix,kz) + d2eidr2*zki*xji*sinik
        dervi(iy,kz) = dervi(iy,kz) + d2eidr2*zki*yji*sinik
        dervi(iz,kz) = dervi(iz,kz) + d2eidr2*zki*zji*sinik
!
!  I-J
!
...
!
        derv2(jx,kx) = derv2(jx,kx) + d2eidr2*xji*xki*cosjk
        derv2(jy,kx) = derv2(jy,kx) + d2eidr2*yji*xki*cosjk
        derv2(jz,kx) = derv2(jz,kx) + d2eidr2*zji*xki*cosjk
        derv2(jx,ky) = derv2(jx,ky) + d2eidr2*xji*yki*cosjk
        derv2(jy,ky) = derv2(jy,ky) + d2eidr2*yji*yki*cosjk
        derv2(jz,ky) = derv2(jz,ky) + d2eidr2*zji*yki*cosjk
        derv2(jx,kz) = derv2(jx,kz) + d2eidr2*xji*zki*cosjk
        derv2(jy,kz) = derv2(jy,kz) + d2eidr2*yji*zki*cosjk
        derv2(jz,kz) = derv2(jz,kz) + d2eidr2*zji*zki*cosjk
!
        dervi(jx,kx) = dervi(jx,kx) - d2eidr2*xji*xki*sinjk
        dervi(jy,kx) = dervi(jy,kx) - d2eidr2*yji*xki*sinjk
        dervi(jz,kx) = dervi(jz,kx) - d2eidr2*zji*xki*sinjk
        dervi(jx,ky) = dervi(jx,ky) - d2eidr2*xji*yki*sinjk
        dervi(jy,ky) = dervi(jy,ky) - d2eidr2*yji*yki*sinjk
        dervi(jz,ky) = dervi(jz,ky) - d2eidr2*zji*yki*sinjk
        dervi(jx,kz) = dervi(jx,kz) - d2eidr2*xji*zki*sinjk
        dervi(jy,kz) = dervi(jy,kz) - d2eidr2*yji*zki*sinjk
        dervi(jz,kz) = dervi(jz,kz) - d2eidr2*zji*zki*sinjk
!
        rrik3 = rrik**3
...
!
        derv2(ix,kx) = derv2(ix,kx) - (deidwi2*d2wkj2(1,1) + d2eidwi22*dwji2(1)*dwki2(1))*cosik
        derv2(iy,kx) = derv2(iy,kx) - (deidwi2*d2wkj2(1,2) + d2eidwi22*dwji2(2)*dwki2(1))*cosik
        derv2(iz,kx) = derv2(iz,kx) - (deidwi2*d2wkj2(1,3) + d2eidwi22*dwji2(3)*dwki2(1))*cosik
        derv2(ix,ky) = derv2(ix,ky) - (deidwi2*d2wkj2(2,1) + d2eidwi22*dwji2(1)*dwki2(2))*cosik
        derv2(iy,ky) = derv2(iy,ky) - (deidwi2*d2wkj2(2,2) + d2eidwi22*dwji2(2)*dwki2(2))*cosik
        derv2(iz,ky) = derv2(iz,ky) - (deidwi2*d2wkj2(2,3) + d2eidwi22*dwji2(3)*dwki2(2))*cosik
        derv2(ix,kz) = derv2(ix,kz) - (deidwi2*d2wkj2(3,1) + d2eidwi22*dwji2(1)*dwki2(3))*cosik
        derv2(iy,kz) = derv2(iy,kz) - (deidwi2*d2wkj2(3,2) + d2eidwi22*dwji2(2)*dwki2(3))*cosik
        derv2(iz,kz) = derv2(iz,kz) - (deidwi2*d2wkj2(3,3) + d2eidwi22*dwji2(3)*dwki2(3))*cosik
!
        dervi(ix,kx) = dervi(ix,kx) + (deidwi2*d2wkj2(1,1) + d2eidwi22*dwji2(1)*dwki2(1))*sinik
        dervi(iy,kx) = dervi(iy,kx) + (deidwi2*d2wkj2(1,2) + d2eidwi22*dwji2(2)*dwki2(1))*sinik
        dervi(iz,kx) = dervi(iz,kx) + (deidwi2*d2wkj2(1,3) + d2eidwi22*dwji2(3)*dwki2(1))*sinik
        dervi(ix,ky) = dervi(ix,ky) + (deidwi2*d2wkj2(2,1) + d2eidwi22*dwji2(1)*dwki2(2))*sinik
        dervi(iy,ky) = dervi(iy,ky) + (deidwi2*d2wkj2(2,2) + d2eidwi22*dwji2(2)*dwki2(2))*sinik
        dervi(iz,ky) = dervi(iz,ky) + (deidwi2*d2wkj2(2,3) + d2eidwi22*dwji2(3)*dwki2(2))*sinik
        dervi(ix,kz) = dervi(ix,kz) + (deidwi2*d2wkj2(3,1) + d2eidwi22*dwji2(1)*dwki2(3))*sinik
        dervi(iy,kz) = dervi(iy,kz) + (deidwi2*d2wkj2(3,2) + d2eidwi22*dwji2(2)*dwki2(3))*sinik
        dervi(iz,kz) = dervi(iz,kz) + (deidwi2*d2wkj2(3,3) + d2eidwi22*dwji2(3)*dwki2(3))*sinik
!
...
!
        derv2(jx,kx) = derv2(jx,kx) + (deidwi2*d2wkj2(1,1) + d2eidwi22*dwji2(1)*dwki2(1))*cosjk
        derv2(jy,kx) = derv2(jy,kx) + (deidwi2*d2wkj2(1,2) + d2eidwi22*dwji2(2)*dwki2(1))*cosjk
        derv2(jz,kx) = derv2(jz,kx) + (deidwi2*d2wkj2(1,3) + d2eidwi22*dwji2(3)*dwki2(1))*cosjk
        derv2(jx,ky) = derv2(jx,ky) + (deidwi2*d2wkj2(2,1) + d2eidwi22*dwji2(1)*dwki2(2))*cosjk
        derv2(jy,ky) = derv2(jy,ky) + (deidwi2*d2wkj2(2,2) + d2eidwi22*dwji2(2)*dwki2(2))*cosjk
        derv2(jz,ky) = derv2(jz,ky) + (deidwi2*d2wkj2(2,3) + d2eidwi22*dwji2(3)*dwki2(2))*cosjk
        derv2(jx,kz) = derv2(jx,kz) + (deidwi2*d2wkj2(3,1) + d2eidwi22*dwji2(1)*dwki2(3))*cosjk
        derv2(jy,kz) = derv2(jy,kz) + (deidwi2*d2wkj2(3,2) + d2eidwi22*dwji2(2)*dwki2(3))*cosjk
        derv2(jz,kz) = derv2(jz,kz) + (deidwi2*d2wkj2(3,3) + d2eidwi22*dwji2(3)*dwki2(3))*cosjk
!
        dervi(jx,kx) = dervi(jx,kx) - (deidwi2*d2wkj2(1,1) + d2eidwi22*dwji2(1)*dwki2(1))*sinjk
        dervi(jy,kx) = dervi(jy,kx) - (deidwi2*d2wkj2(1,2) + d2eidwi22*dwji2(2)*dwki2(1))*sinjk
        dervi(jz,kx) = dervi(jz,kx) - (deidwi2*d2wkj2(1,3) + d2eidwi22*dwji2(3)*dwki2(1))*sinjk
        dervi(jx,ky) = dervi(jx,ky) - (deidwi2*d2wkj2(2,1) + d2eidwi22*dwji2(1)*dwki2(2))*sinjk
        dervi(jy,ky) = dervi(jy,ky) - (deidwi2*d2wkj2(2,2) + d2eidwi22*dwji2(2)*dwki2(2))*sinjk
        dervi(jz,ky) = dervi(jz,ky) - (deidwi2*d2wkj2(2,3) + d2eidwi22*dwji2(3)*dwki2(2))*sinjk
        dervi(jx,kz) = dervi(jx,kz) - (deidwi2*d2wkj2(3,1) + d2eidwi22*dwji2(1)*dwki2(3))*sinjk
        dervi(jy,kz) = dervi(jy,kz) - (deidwi2*d2wkj2(3,2) + d2eidwi22*dwji2(2)*dwki2(3))*sinjk
        dervi(jz,kz) = dervi(jz,kz) - (deidwi2*d2wkj2(3,3) + d2eidwi22*dwji2(3)*dwki2(3))*sinjk
      enddo
    enddo
  enddo
!
...
!
  ...
  if (status/=0) call deallocate_error('valencebondp','d2i')
  deallocate(d1i,stat=status)
  if (status/=0) call deallocate_error('valencebondp','d1i')
  deallocate(bvv,stat=status)
  if (status/=0) call deallocate_error('valencebondp','vbv')
  deallocate(bv,stat=status)
  if (status/=0) call deallocate_error('valencebondp','vb')
  deallocate(nvbijptr,stat=status)
  if (status/=0) call deallocate_error('valencebondp','nvbijptr')
!
  t2 = g_cpu_time()
  tval = tval + t2 - t1
#ifdef TRACE
  call trace_out('valencebondp')
#endif
!
  return
  end
