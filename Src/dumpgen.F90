...
!  Eigenvector type  *
!*********************
  if (leigenvectors_original.and..not.leigenvectors_phase) then
    write(iout,'(''eigvector_type original unphased'')')
  elseif (leigenvectors_original) then
    write(iout,'(''eigvector_type original'')')
  elseif (.not.leigenvectors_phase) then
    write(iout,'(''eigvector_type unphased'')')
  endif
!******************
!  Terse options  *
!******************
