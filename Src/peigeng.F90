...
!
  ...
  if (status/=0) call outofmemory('peigeng','egr')
  allocate(enorm(mtv),stat=status)
  if (status/=0) call outofmemory('peigeng','enorm')
!
    ...
    if (igroup.gt.0) then
      do i = 1,igroup
        ...
        do j = 1,njloop
          ...
          enddo
!
          write(ioout,'(i6,'' x '',5x,6f10.6)') j,(egrl(1,k),k=1,6)
          write(ioout,'(i6,'' y '',5x,6f10.6)') j,(egrl(2,k),k=1,6)
          write(ioout,'(i6,'' z '',5x,6f10.6)') j,(egrl(3,k),k=1,6)
          indj = indj + 3
        enddo
        if (lrigid) then
          do j = 1,nphonatm
            ...
            enddo
!
            write(ioout,'(i6,'' Tx'',5x,6f10.6)') j,(egrl(1,k),k=1,6)
            write(ioout,'(i6,'' Ty'',5x,6f10.6)') j,(egrl(2,k),k=1,6)
            write(ioout,'(i6,'' Tz'',5x,6f10.6)') j,(egrl(3,k),k=1,6)
            write(ioout,'(i6,'' R1'',5x,6f10.6)') j,(egrl(4,k),k=1,6)
            write(ioout,'(i6,'' R2'',5x,6f10.6)') j,(egrl(5,k),k=1,6)
            write(ioout,'(i6,'' R3'',5x,6f10.6)') j,(egrl(6,k),k=1,6)
            indj = indj + 6
          enddo
        endif
        indi = indi + 6
    ...
    if (iresid.gt.0) then
      ...
      do j = 1,njloop
        ...
        enddo
!
        write(ioout,'(i6,'' x '',5x,6f10.6)') j,(egrl(1,k),k=1,iresid)
        write(ioout,'(i6,'' y '',5x,6f10.6)') j,(egrl(2,k),k=1,iresid)
        write(ioout,'(i6,'' z '',5x,6f10.6)') j,(egrl(3,k),k=1,iresid)
        indj = indj + 3
      enddo
      if (lrigid) then
        do j = 1,nphonatm
          ...
          enddo
!
          write(ioout,'(i6,'' Tx'',5x,6f10.6)') j,(egrl(1,k),k=1,iresid)
          write(ioout,'(i6,'' Ty'',5x,6f10.6)') j,(egrl(2,k),k=1,iresid)
          write(ioout,'(i6,'' Tz'',5x,6f10.6)') j,(egrl(3,k),k=1,iresid)
          write(ioout,'(i6,'' Q1'',5x,6f10.6)') j,(egrl(4,k),k=1,iresid)
          write(ioout,'(i6,'' Q2'',5x,6f10.6)') j,(egrl(5,k),k=1,iresid)
          write(ioout,'(i6,'' Q3'',5x,6f10.6)') j,(egrl(6,k),k=1,iresid)
          indj = indj + 6
        enddo
      endif
    endif
...
!
  ...
  if (status/=0) call deallocate_error('peigeng','enorm')
  deallocate(egr,stat=status)
  if (status/=0) call deallocate_error('peigeng','egr')
#ifdef TRACE
