...
!   8/22 Maximum temperature trap turned off if the user specifies the velocities
!        and the target temperature is zero
!
!  Conditions of use:
!
...
!
  if (.not.linputvelxyz.or.targettemperature.gt.0.0_dp) then
