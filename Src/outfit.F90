...
!  Output values
!
      write(ioout,'(4x,i7,8x,a13,1x,3(f12.5,1x),f8.3)') i,nameobs(nobtyp(i)),fobs(i),fcalc(i),fres(i),percent
    else
      write(ioout,'(4x,i7,8x,a13,1x,3(f12.5,1x))') i,nameobs(nobtyp(i)),fobs(i),fcalc(i),fres(i)
    endif
  enddo
  write(ioout,'(''--------------------------------------------------------------------------------'')')
!
  ...
  do i = 1,nobs
    if (nobtyp(i).eq.29) then
      write(ioout,'(4x,i7,8x,a4,1x,f6.4,3x,3(f12.5,1x))') i,nameobs(nobtyp(i))(1:4),finfo(i),fobs(i),fcalcoriginal(i),fcalc(i)
    else
      write(ioout,'(4x,i7,8x,a13,1x,3(f12.5,1x))') i,nameobs(nobtyp(i)),fobs(i),fcalcoriginal(i),fcalc(i)
    endif
  enddo
  write(ioout,'(''--------------------------------------------------------------------------------'')')
!
