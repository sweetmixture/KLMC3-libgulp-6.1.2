...
!
  ...
  call realloc(ltib3body,maxthb,ierror)
  if (ierror.ne.0) call outofmemory('changemaxthb','ltib3body')
  call realloc(ltif3body,maxthb,ierror)
  if (ierror.ne.0) call outofmemory('changemaxthb','ltif3body')
!
