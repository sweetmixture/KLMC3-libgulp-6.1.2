...
!
      if (nthrty(i).eq.1) then
        if (mmtexc(i).eq.1) then
          if (thrho1(i).ne.0.0_dp.and.thrho2(i).ne.0.0_dp) then
            if (lfit) then
              write(iout,'(''three k3 k4 bond '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          ...
          elseif (thrho2(i).ne.0.0_dp) then
            if (lfit) then
              write(iout,'(''three k3 bond '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          ...
          elseif (thrho1(i).ne.0.0_dp) then
            if (lfit) then
              write(iout,'(''three k4 bond '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
              write(iout,'(3(a5,1x,a4,1x),3(g11.4,1x),3i2)') lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i), &
            ...
            if (lfit) then
              write(iout,'(''three bond '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          ...
          if (thrho1(i).ne.0.0_dp.and.thrho2(i).ne.0.0_dp) then
            if (lfit) then
              write(iout,'(''three k3 k4 '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          ...
          elseif (thrho2(i).ne.0.0_dp) then
            if (lfit) then
              write(iout,'(''three k3 '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
              write(iout,'(3(a5,1x,a4,1x),3(g11.4,1x),''&'')') &
          ...
          elseif (thrho1(i).ne.0.0_dp) then
            if (lfit) then
              write(iout,'(''three k4 '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
              write(iout,'(3(a5,1x,a4,1x),3(g11.4,1x),''&'')') &
            ...
            if (lfit) then
              write(iout,'(''three '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
        ...
        if (mmtexc(i).eq.1) then
          if (lfit) then
            if (nthrty(i).eq.2) then
              write(iout,'(''three exponential bond '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
            else
              write(iout,'(''three vessal bond '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
            endif
          ...
          if (lfit) then
            if (nthrty(i).eq.2) then
              write(iout,'(''three exponential '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
            else
              write(iout,'(''three vessal '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
            endif
            write(iout,'(3(a5,1x,a3,1x),g17.6,1x,f8.4,2(1x,f8.6),'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),the,rho1,rho2
      ...
      elseif (nthrty(i).eq.3) then
        if (mmtexc(i).eq.1) then
          write(iout,'(''axilrod-teller bond '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          if (lfit) then
          ...
          write(iout,'(''axilrod-teller '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
      ...
      elseif (nthrty(i).eq.4) then
        if (mmtexc(i).eq.1) then
          write(iout,'(''exponential bond '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          if (lfit) then
          ...
          write(iout,'(''exponential '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
      ...
      elseif (nthrty(i).eq.5) then
        if (abs(thrho3(i)).gt.0.0_dp) then
          write(iout,'(''sw3 modified '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          ...
          write(iout,'(''sw3 '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          write(iout,'(3(a5,1x,a4,1x),g14.6,1x,f8.4,2(1x,f8.6),'' &'')') &
            lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),the,thrho1(i),thrho2(i)
          if (lfit) then
            write(iout,'(6(1x,f8.3),4i2)') &
      ...
      elseif (nthrty(i).eq.6) then
        ...
        rho2 = thrho2(i)
        if (mmtexc(i).eq.1) then
          write(iout,'(''bcross bond '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          if (lfit) then
          ...
          write(iout,'(''bcross '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          write(iout,'(3(a5,1x,a3,1x),g11.5,1x,2(1x,f8.6),'' &'')') &
            lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),rho1,rho2
          if (lfit) then
      ...
      elseif (nthrty(i).eq.7) then
        if (mmtexc(i).eq.1) then
          write(iout,'(''urey-bradley bond '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          if (lfit) then
          ...
          write(iout,'(''urey-bradley '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
      ...
      elseif (nthrty(i).eq.9) then
        if (mmtexc(i).eq.1) then
          if (thrho1(i).ne.0.0_dp.and.thrho2(i).ne.0.0_dp) then
            if (lfit) then
              write(iout,'(''three cosine k3 k4 bond '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          ...
          elseif (thrho2(i).ne.0.0_dp) then
            if (lfit) then
              write(iout,'(''three cosine k3 bond '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
              write(iout,'(3(a5,1x,a4,1x),2(g15.8,1x),''&'')') lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),thrho2(i)
          ...
          elseif (thrho1(i).ne.0.0_dp) then
            if (lfit) then
              write(iout,'(''three cosine k4 bond '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
            ...
            if (lfit) then
              write(iout,'(''three cosine bond '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          ...
          if (thrho1(i).ne.0.0_dp.and.thrho2(i).ne.0.0_dp) then
            if (lfit) then
              write(iout,'(''three cosine k3 k4 '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          ...
          elseif (thrho2(i).ne.0.0_dp) then
            if (lfit) then
              write(iout,'(''three cosine k3 '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
              write(iout,'(3(a5,1x,a4,1x),2(g15.8,1x),''&'')') &
                lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),thrho2(i)
          ...
          elseif (thrho1(i).ne.0.0_dp) then
            if (lfit) then
              write(iout,'(''three cosine k4 '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
              write(iout,'(3(a5,1x,a4,1x),2(g15.8,1x),''&'')') &
            ...
            if (lfit) then
              write(iout,'(''three cosine '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
              write(iout,'(3(a5,1x,a4,1x),2(g15.8,1x),''&'')') &
                lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),the
      ...
      elseif (nthrty(i).eq.10) then
        if (mmtexc(i).eq.1) then
          write(iout,'(''murrel-mottram bond '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          ...
          write(iout,'(''murrel-mottram '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          write(iout,'(3(a5,1x,a4,1x),g14.6,1x,f8.5,'' &'')') &
            lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),theta(i)
          if (lfit) then
      ...
      elseif (nthrty(i).eq.11) then
        if (mmtexc(i).eq.1) then
          write(iout,'(''bacross bond '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          write(iout,'(3(a5,1x,a4,1x),g14.6,1x,f8.5,'' &'')') &
          ...
          write(iout,'(''bacross '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          write(iout,'(3(a5,1x,a4,1x),g14.6,1x,f8.5,'' &'')') &
            lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),thrho3(i)
          if (lfit) then
      ...
      elseif (nthrty(i).eq.12) then
        if (mmtexc(i).eq.1) then
          write(iout,'(''lin3 bond '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          if (lfit) then
          ...
          write(iout,'(''lin3 '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
      ...
      elseif (nthrty(i).eq.13) then
        ...
        rho2 = thrho2(i)
        if (mmtexc(i).eq.1) then
          write(iout,'(''bcoscross bond '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          if (lfit) then
          ...
          write(iout,'(''bcoscross '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
      ...
      elseif (nthrty(i).eq.14) then
        write(iout,'(''sw3jb '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
        write(iout,'(3(a5,1x,a4,1x),g14.6,1x,f8.4,2(1x,f8.6),'' &'')') &
          lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),the,thrho1(i),thrho2(i)
        if (lfit) then
      ...
      elseif (nthrty(i).eq.15) then
        if (ltdreiding(i)) then
          write(iout,'(''hydrogen-bond dreiding '',3i3,1x,a5,6(1x,a9))') nint(thrho1(i)),nint(thrho2(i)), &
            nint(thrho3(i)),mword(nmtptr),(wboty(j),j=1,nboty)
        else
          write(iout,'(''hydrogen-bond '',3i3,1x,a5,6(1x,a9))') nint(thrho1(i)),nint(thrho2(i)),nint(thrho3(i)), &
      ...
      elseif (nthrty(i).eq.16) then
        ...
        if (mmtexc(i).eq.1) then
          if (lfit) then
            write(iout,'(''equatorial bond '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
            write(iout,'(3(a5,1x,a3,1x),g17.6,1x,f8.4,2(1x,f8.6),'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),the,rho1,rho2
          ...
          if (lfit) then
            write(iout,'(''equatorial '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
            write(iout,'(3(a5,1x,a3,1x),g17.6,1x,f8.4,2(1x,f8.6),'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),the,rho1,rho2
            write(iout,'(6(1x,f8.3),3i2)') thr1min(i),thr1(i),thr2min(i),thr2(i),thr3min(i),thr3(i), &
      ...
      elseif (nthrty(i).eq.17) then
        if (mmtexc(i).eq.1) then
          if (lfit) then
            write(iout,'(''uff3 bond '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
            write(iout,'(3(a5,1x,a4,1x),g10.5,1x,g10.5,2i2)') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),the,itmp(16*(i-1)+1),itmp(16*(i-1)+2)
          else
            write(iout,'(''uff3 bond '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          ...
          if (lfit) then
            write(iout,'(''uff3 '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
            write(iout,'(3(a5,1x,a4,1x),g10.5,1x,f10.6,'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),the
            write(iout,'(6(1x,f6.3),2i2)')thr1min(i),thr1(i), &
              thr2min(i),thr2(i),thr3min(i),thr3(i),itmp(16*(i-1)+1),itmp(16*(i-1)+2)
      ...
      elseif (nthrty(i).eq.18) then
        if (mmtexc(i).eq.1) then
          write(iout,'(''bacoscross '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          write(iout,'(3(a5,1x,a4,1x),g14.6,1x,f8.5,'' &'')') &
            lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),thrho3(i)
          if (lfit) then
            write(iout,'(2(1x,f8.6),1x,f8.4,5i2)')thrho1(i),thrho2(i),the,(itmp(16*(i-1)+j),j=1,5)
      ...
      elseif (nthrty(i).eq.19) then
        if (mmtexc(i).eq.1) then
          write(iout,'(''3coulomb bond '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          write(iout,'(3(a5,1x,a3,1x),g11.5)') lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i)
        else
          write(iout,'(''3coulomb '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
      ...
      elseif (nthrty(i).eq.20) then
        if (mmtexc(i).eq.1) then
          write(iout,'(''exp2 '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
      ...
      elseif (nthrty(i).eq.21) then
        if (mmtexc(i).eq.1) then
          if (lfit) then
            write(iout,'(''g3coulomb bond '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
            write(iout,'(3(a5,1x,a4,1x),g10.5,1x,g10.5,2i2)') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),the,itmp(16*(i-1)+1),itmp(16*(i-1)+2)
          else
            write(iout,'(''g3coulomb bond '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          ...
          if (lfit) then
            write(iout,'(''g3coulomb '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
            write(iout,'(3(a5,1x,a4,1x),g10.5,1x,f10.6,'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),the
            write(iout,'(6(1x,f6.3),2i2)')thr1min(i),thr1(i), &
              thr2min(i),thr2(i),thr3min(i),thr3(i),itmp(16*(i-1)+1),itmp(16*(i-1)+2)
      ...
      elseif (nthrty(i).eq.22) then
        if (mmtexc(i).eq.1) then
          write(iout,'(''bagcross bond '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          write(iout,'(3(a5,1x,a4,1x),g14.6,2(1x,f8.5),'' &'')') &
          ...
          write(iout,'(''bagcross '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          write(iout,'(3(a5,1x,a4,1x),g14.6,2(1x,f8.5),'' &'')') &
            lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),thrho1(i),thrho2(i)
          if (lfit) then
      ...
      elseif (nthrty(i).eq.23) then
        if (mmtexc(i).eq.1) then
          write(iout,'(''balcross bond '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          write(iout,'(3(a5,1x,a4,1x),g14.6,2(1x,f8.5),'' &'')') &
            lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),thrho1(i),thrho2(i)
          if (lfit) then
          ...
          write(iout,'(''balcross '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          write(iout,'(3(a5,1x,a4,1x),g14.6,2(1x,f8.5),'' &'')') &
            lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),thrho1(i),thrho2(i)
          if (lfit) then
      ...
      elseif (nthrty(i).eq.24) then
        if (mmtexc(i).eq.1) then
          if (lfit) then
            write(iout,'(''mm3angle bond '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          ...
          write(iout,'(''mm3angle '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          write(iout,'(3(a5,1x,a4,1x),g10.5,1x,g10.5,1x,f10.6,'' &'')') &
            lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),the,threepoly(1,i)
          write(iout,'(4x,4(g12.6,1x),'' &'')') &
            (threepoly(j,i),j=2,5)
      ...
      elseif (nthrty(i).eq.25) then
        write(iout,'(''sw3 garofalini '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
        write(iout,'(3(a5,1x,a4,1x),g14.6,1x,f8.4,2(1x,f8.6),'' &'')') &
          lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),the,thrho1(i),thrho2(i)
        if (lfit) then
          write(iout,'(6(1x,f8.3),4i2)') &
      ...
      elseif (nthrty(i).eq.26) then
        if (mmtexc(i).eq.1) then
          write(iout,'(''j3 bond '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          if (lfit) then
          ...
          write(iout,'(''j3 '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
      ...
      elseif (nthrty(i).eq.27) then
        if (mmtexc(i).eq.1) then
          write(iout,'(''ppp3body bond '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          if (lfit) then
            write(iout,'(3(a5,1x,a4,1x),g14.6,3(1x,f8.6),4i2)') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i), &
          ...
          write(iout,'(''ppp3body '',a5,6(1x,a9))') mword(nmtptr),(wboty(j),j=1,nboty)
          write(iout,'(3(a5,1x,a4,1x),g14.6,3(1x,f8.6),'' &'')') &
            lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),thbk(i),thrho1(i),thrho2(i),thrho3(i)
          if (lfit) then
            write(iout,'(6(1x,f8.3),4i2)') &
...
!
      if (nforty(i).eq.1) then
        ...
        if (mmfexc(i).eq.1) then
          if (lfit) then
            write(iout,'(''torsion bond '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
        ...
        elseif (mmfexc(i).eq.2) then
          if (lfit) then
            write(iout,'(''torsion improper '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),g12.5,1x,i3,1x,g10.5,i2)') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),npfor(i),phi0,itmp(6*(i-1)+1)
          else
            write(iout,'(''torsion improper '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
          ...
          if (lfit) then
            write(iout,'(''torsion '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),g12.5,1x,i3,1x,g10.5,'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),npfor(i),phi0
      ...
      elseif (nforty(i).eq.2) then
        if (mmfexc(i).eq.1) then
          if (lfit) then
            write(iout,'(''torsion ryckaert '',i1,'' bond '',a5,4(1x,a9))') npfor(i),mword(nmfptr), &
        ...
        elseif (mmfexc(i).eq.2) then
          if (lfit) then
            write(iout,'(''torsion ryckaert '',i1,'' improper '',a5,4(1x,a9))') npfor(i),mword(nmfptr), &
              (botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),g12.5,1x,6i2)') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),(itmp(6*(i-1)+j),j=1,npfor(i)+1)
            write(iout,'(5(f12.6,1x))')(forpoly(j,i),j=1,npfor(i))
          ...
          if (lfit) then
            write(iout,'(''torsion ryckaert '',i1,1x,a5,4(1x,a9))') npfor(i),mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
      ...
      elseif (nforty(i).eq.3) then
        if (mmfexc(i).eq.1) then
          if (lfit) then
            write(iout,'(''outofplane bond '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
          ...
          if (lfit) then
            write(iout,'(''outofplane '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),2(g12.5,1x),'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),forpoly(1,i)
      ...
      elseif (nforty(i).eq.4) then
        ...
        if (mmfexc(i).eq.1) then
          if (lfit) then
            write(iout,'(''torsion esff bond '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
        ...
        elseif (mmfexc(i).eq.2) then
          if (lfit) then
            write(iout,'(''torsion esff improper '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),2(g12.5,1x),i3,1x,2i2)') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),phi0,npfor(i),(itmp(6*(i-1)+j),j=1,2)
          else
            write(iout,'(''torsion esff improper '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
          ...
          if (lfit) then
            write(iout,'(''torsion esff '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
      ...
      elseif (nforty(i).eq.5) then
        ...
        if (mmfexc(i).eq.1) then
          if (lfit) then
            write(iout,'(''torharm bond '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
        ...
        elseif (mmfexc(i).eq.2) then
          if (lfit) then
            write(iout,'(''torharm improper '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),2(g12.5,1x),1x,2i2)') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),phi0,(itmp(6*(i-1)+j),j=1,2)
          else
            write(iout,'(''torharm improper '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
          ...
          if (lfit) then
            write(iout,'(''torharm '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),2(g12.5,1x),'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),phi0
      ...
      elseif (nforty(i).eq.6) then
        ...
        if (mmfexc(i).eq.1) then
          if (lfit) then
            write(iout,'(''torexp bond '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),g12.5,1x,i3,1x,g10.5,'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),npfor(i),phi0
        ...
        elseif (mmfexc(i).eq.2) then
          if (lfit) then
            write(iout,'(''torexp improper '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),g12.5,1x,i3,1x,g10.5,'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),npfor(i),phi0
            write(iout,'(2x,3(g10.6,1x),1x,4i2)') forpoly(2,i),forpoly(3,i),forpoly(4,i),itmp(6*(i-1)+1),(itmp(6*(i-1)+j),j=3,5)
          else
          ...
          if (lfit) then
            write(iout,'(''torexp '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),g12.5,1x,i3,1x,g10.5,'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),npfor(i),phi0
      ...
      elseif (nforty(i).eq.7) then
        if (mmfexc(i).eq.1) then
          if (lfit) then
            write(iout,'(''torexp bond esff '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
        ...
        elseif (mmfexc(i).eq.2) then
          if (lfit) then
            write(iout,'(''torexp improper esff '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),g12.5,1x,g12.5,i3,1x,'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),forpoly(1,i),npfor(i)
            write(iout,'(2x,3(g10.6,1x),1x,5i2)') forpoly(2,i),forpoly(3,i),forpoly(4,i),(itmp(6*(i-1)+j),j=1,5)
          else
          ...
          if (lfit) then
            write(iout,'(''torexp esff '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),g12.5,1x,g12.5,i3,1x,'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),forpoly(1,i),npfor(i)
      ...
      elseif (nforty(i).eq.8) then
        ...
        if (mmfexc(i).eq.1) then
          if (lfit) then
            write(iout,'(''tortaper bond '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),g12.5,1x,i3,1x,g10.5,'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),npfor(i),phi0
        ...
        elseif (mmfexc(i).eq.2) then
          if (lfit) then
            write(iout,'(''tortaper improper '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),g12.5,1x,i3,1x,g10.5,'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),npfor(i),phi0
            write(iout,'(2x,g10.6,1x,4i2)') forpoly(2,i),itmp(6*(i-1)+1),(itmp(6*(i-1)+j),j=3,5)
          else
          ...
          if (lfit) then
            write(iout,'(''tortaper '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),g12.5,1x,i3,1x,g10.5,'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),npfor(i),phi0
      ...
      elseif (nforty(i).eq.9) then
        if (mmfexc(i).eq.1) then
          if (lfit) then
            write(iout,'(''tortaper bond esff '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),g12.5,1x,g12.5,i3,1x,'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),forpoly(1,i),npfor(i)
        ...
        elseif (mmfexc(i).eq.2) then
          if (lfit) then
            write(iout,'(''tortaper improper esff '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),g12.5,1x,g12.5,i3,1x,'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),forpoly(1,i),npfor(i)
            write(iout,'(2x,g10.6,1x,1x,5i2)') forpoly(2,i),(itmp(6*(i-1)+j),j=1,5)
          else
          ...
          if (lfit) then
            write(iout,'(''tortaper esff '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),g12.5,1x,g12.5,i3,1x,'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),forpoly(1,i),npfor(i)
      ...
      elseif (nforty(i).eq.10) then
        if (mmfexc(i).eq.1) then
          if (lfit) then
            write(iout,'(''torangle bond '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
        ...
        elseif (mmfexc(i).eq.2) then
          if (lfit) then
            write(iout,'(''torangle improper '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),3(g10.5,1x),1x,3i2)') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),forpoly(1,i),forpoly(2,i), &
              (itmp(6*(i-1)+j),j=1,3)
          else
          ...
          if (lfit) then
            write(iout,'(''torangle '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),3(g10.5,1x),'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),forpoly(1,i),forpoly(2,i)
      ...
      elseif (nforty(i).eq.11) then
        if (mmfexc(i).eq.1) then
          if (lfit) then
            write(iout,'(''inversion bond '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
          ...
          if (lfit) then
            write(iout,'(''inversion '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
      ...
      elseif (nforty(i).eq.12) then
        if (mmfexc(i).eq.1) then
          if (lfit) then
            write(iout,'(''inversion squared bond '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
          ...
          if (lfit) then
            write(iout,'(''inversion squared '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
      ...
      elseif (nforty(i).eq.13) then
        ...
        if (mmfexc(i).eq.1) then
          if (lfit) then
            write(iout,'(''uff4 bond '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
        ...
        elseif (mmfexc(i).eq.2) then
          if (lfit) then
            write(iout,'(''uff4 improper '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),g10.5,1x,i3,1x,g10.5,i2)') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),npfor(i),phi0,itmp(6*(i-1)+1)
          else
            write(iout,'(''uff4 improper '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
          ...
          if (lfit) then
            write(iout,'(''uff4 '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),g10.5,1x,i3,1x,g10.5,'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),npfor(i),phi0
            write(iout,'(4f5.2,i2)') for1(i),for2(i),for3(i),for4(i),itmp(6*(i-1)+1)
          else
      ...
      elseif (nforty(i).eq.14) then
        if (mmfexc(i).eq.1) then
          if (lfit) then
            write(iout,'(''xangleangle bond '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),3(g10.5,1x),'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),forpoly(1,i),forpoly(2,i)
          ...
          if (lfit) then
            write(iout,'(''xangleangle '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),3(g10.5,1x),'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),forpoly(1,i),forpoly(2,i)
      ...
      elseif (nforty(i).eq.15) then
        if (mmfexc(i).eq.1) then
          if (lfit) then
            write(iout,'(''uffoop bond '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
          ...
          write(iout,'(''uffoop '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
          write(iout,'(4(a5,1x,a3,1x),g10.5,1x,3(f6.3,1x),'' &'')') &
            lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),(forpoly(k,i),k=1,3)
          if (lfit) then
      ...
      elseif (nforty(i).eq.16) then
        if (mmfexc(i).eq.1) then
          if (lfit) then
            write(iout,'(''xcosangleangle bond '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),3(g10.5,1x),'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),forpoly(1,i),forpoly(2,i)
            write(iout,'(4x,3(f8.4,1x),6i2)') &
              forpoly(3,i),forpoly(4,i),forpoly(5,i),(itmp(6*(i-1)+j),j=1,6)
          ...
          if (lfit) then
            write(iout,'(''xcosangleangle '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),3(g10.5,1x),'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),forpoly(1,i),forpoly(2,i)
            write(iout,'(4x,3(f8.4,1x),3(f6.3,1x),6i2)') &
              forpoly(3,i),forpoly(4,i),forpoly(5,i),for1(i),for2(i),for3(i), &
      ...
      elseif (nforty(i).eq.17) then
        if (mmfexc(i).eq.1) then
          if (lfit) then
            write(iout,'(''torcosangle bond '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),3(g10.5,1x),1x,3i2)') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),forpoly(1,i),forpoly(2,i), &
              (itmp(6*(i-1)+j),j=1,3)
          else
        ...
        elseif (mmfexc(i).eq.2) then
          if (lfit) then
            write(iout,'(''torcosangle improper '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),3(g10.5,1x),1x,3i2)') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),forpoly(1,i),forpoly(2,i), &
              (itmp(6*(i-1)+j),j=1,3)
          else
          ...
          if (lfit) then
            write(iout,'(''torcosangle '',a5,4(1x,a9))') mword(nmfptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(4(a5,1x,a3,1x),3(g10.5,1x),'' &'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),fork(i),forpoly(1,i),forpoly(2,i)
            write(iout,'(4f5.2,3i2)') for1(i),for2(i),for3(i),for4(i),(itmp(6*(i-1)+j),j=1,3)
          else
...
!
      if (nsixty(i).eq.1) then
        if (mmsexc(i).eq.1) then
          if (lfit) then
            write(iout,'(''xoutofplane bond '',a5,3(1x,a9))') mword(nmsptr),(botyword(nbotyptr(j)),j=1,nboty)
          ...
          if (lfit) then
            write(iout,'(''xoutofplane '',a5,3(1x,a9))') mword(nmsptr),(botyword(nbotyptr(j)),j=1,nboty)
            write(iout,'(6(a5,1x,a3,1x),g15.6,1x,''&'')') &
              lab1,ctmp(1),lab2,ctmp(2),lab3,ctmp(3),lab4,ctmp(4),lab5,ctmp(5),lab6,ctmp(6),sixk(i)
