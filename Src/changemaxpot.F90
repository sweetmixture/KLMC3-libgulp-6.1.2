...
!
  ...
  call realloc(ltib2body,maxpot,ierror)
  if (ierror.ne.0) call outofmemory('changemaxpot','ltib2body')
  call realloc(ltif2body,maxpot,ierror)
  if (ierror.ne.0) call outofmemory('changemaxpot','ltif2body')
